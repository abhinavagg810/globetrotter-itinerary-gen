      ...
      <div className="relative z-10 w-full min-h-screen flex items-center justify-center p-4">
        <div className="text-center max-w-2xl">
          ...
          <div className="w-full max-w-4xl mx-auto mb-8">
            ...
            <Card className="w-full max-w-lg mx-auto bg-white/95 backdrop-blur-xl border-0 shadow-2xl rounded-3xl overflow-hidden">
            <CardHeader className="text-center space-y-6 pb-8 bg-gradient-to-br from-purple-500/10 to-pink-500/10">
              <div className="mx-auto w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-xl rotate-12 hover:rotate-0 transition-transform duration-300">
                <Plane className="h-10 w-10 text-white" />
              </div>
              <div>
                <CardTitle className="text-3xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-3">
                  Ready to Explore? ✨
                </CardTitle>
                <CardDescription className="text-base text-gray-600 font-medium">Join millions of travelers creating epic adventures</CardDescription>
              </div>
            </CardHeader>
            
            <CardContent className="space-y-4 p-8">
              <Button onClick={onLogin} className="w-full h-14 text-lg font-bold bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200">
                🚀 Start Your Journey
              </Button>
              <Button variant="outline" onClick={onLogin} className="w-full h-14 text-lg font-semibold bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-purple-300 rounded-2xl">
              ...
              <Button variant="outline" onClick={onLogin} className="w-full h-14 text-lg font-semibold bg-blue-600 hover:bg-blue-700 text-white border-0 rounded-2xl">
              ...
              <div className="text-center pt-6">
                <p className="text-sm text-gray-500 leading-relaxed">
                  By joining, you agree to our <span className="text-purple-600 font-medium">Terms</span> & <span className="text-purple-600 font-medium">Privacy Policy</span> 💜
                </p>
              </div>
            </CardContent>
          </Card>
